        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <Reveal>
            ...
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-gray-900 mb-8 lg:mb-12">
              Allowlisting the action<br /><span className="text-[#b82214]">is not enough.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
              ...
              <div className="space-y-5">
                {CONTROLS.map((c) => (
                  <div key={c.k} className="flex items-start gap-5">
                    <span className="text-[#10c689] font-mono text-sm font-semibold w-32 flex-shrink-0 pt-0.5">{c.k}</span>
            ...
            <Reveal delay={0.1}>
              ...
              <div className="relative bg-white border border-gray-200 shadow-soft p-6 lg:p-8 border-l-2 border-l-[#b82214]">
                ...
                <div className="space-y-3 text-sm font-mono">
                  ...
                  <div className="flex justify-between gap-4 pt-3 border-t border-gray-200">
                    ...
                    <span className="text-[#b82214] font-semibold">reverted, 97% below floor</span>
                  </div>
                </div>
              </div>
