...
const CURL_HTML = [
  ...
  `#     <span style="color:${SKY}">"venue"</span>: { <span style="color:${SKY}">"v"</span>: <span style="color:${EM}">"uniswap-v3"</span>, <span style="color:${SKY}">"ok"</span>: <span style="color:#34d399">true</span> },`,
  `#     <span style="color:${SKY}">"slippage_bps"</span>: { <span style="color:${SKY}">"v"</span>: <span style="color:${AMBER}">18</span>, <span style="color:${SKY}">"max"</span>: <span style="color:${AMBER}">50</span>, <span style="color:${SKY}">"ok"</span>: <span style="color:#34d399">true</span> },`,
  ...
  `#     <span style="color:${SKY}">"exit_liquidity_bps"</span>: { <span style="color:${SKY}">"v"</span>: <span style="color:${AMBER}">45</span>, <span style="color:${SKY}">"max"</span>: <span style="color:${AMBER}">60</span>, <span style="color:${SKY}">"ok"</span>: <span style="color:#34d399">true</span> },`,
  `#     <span style="color:${SKY}">"health_factor"</span>: { <span style="color:${SKY}">"v"</span>: <span style="color:${AMBER}">1.9</span>, <span style="color:${SKY}">"min"</span>: <span style="color:${AMBER}">1.5</span>, <span style="color:${SKY}">"ok"</span>: <span style="color:#34d399">true</span> }`,
  `#   },`,
  `#   <span style="color:${SKY}">"counter_offer"</span>: { <span style="color:${SKY}">"trade"</span>: <span style="color:${EM}">"8,200 USDC → WETH"</span>, <span style="color:${SKY}">"price_impact_bps"</span>: <span style="color:${AMBER}">41</span>, <span style="color:${SKY}">"decision"</span>: <span style="color:#34d399">"passes"</span> }`,
  `# }</span>`,
].join('\n');
