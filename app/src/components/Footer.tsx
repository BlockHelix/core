    ...
    <footer className="bg-[#0a0a0a] border-t border-white/10 py-12">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          <div>
            <Link href="/" className="text-xs uppercase tracking-wider-2 font-medium text-white hover:text-emerald-400 transition-colors">
              BlockHelix
            </Link>
          ...
          <nav className="flex flex-wrap gap-6">
            <Link href="/jobs" className="text-xs uppercase tracking-wider text-white/60 hover:text-white transition-colors">
              Hire
            </Link>
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/BlockHelix" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors">
            ...
            <a href="https://x.com/BlockHelix" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors">
