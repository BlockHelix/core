            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-64 px-4 py-4 pl-10 text-sm bg-transparent border border-white/20 text-white placeholder-white/40 focus:outline-none focus:border-white corner-cut-sm transition-colors"
                />
