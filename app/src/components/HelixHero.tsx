          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative">
              <input
                ...
                className="w-full px-6 py-5 pl-14 text-lg bg-white rounded-lg text-black placeholder-black/50 focus:outline-none focus:ring-2 focus:ring-cyan-400 transition-all"
              />
