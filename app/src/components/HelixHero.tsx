            ...
            <div className="w-full max-w-lg space-y-4">
              <div className="relative">
                <input
                  ...
                  className="w-full px-5 py-4 pl-12 text-base bg-transparent border border-white/20 text-white placeholder-white/40 focus:outline-none focus:border-white corner-cut-sm transition-colors"
                />
