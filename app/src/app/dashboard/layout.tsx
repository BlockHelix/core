    ...
    <ToastProvider>
      <main className="mx-auto max-w-6xl px-6 py-10 lg:px-8 lg:py-12">
        <header className="mb-6">
          <h1 className="text-xs font-medium uppercase tracking-wider-2 text-emerald-400">Dashboard</h1>
          <p className="mt-2 text-2xl font-medium text-white">Developer console</p>
        </header>
